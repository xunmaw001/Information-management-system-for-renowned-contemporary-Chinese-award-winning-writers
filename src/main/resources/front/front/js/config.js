...
var centerMenu = [
    ...
    ,{
        name: '作家收藏',
        url: '../zuojiaCollection/list.html'
    }
...
var indexNav = [
    ...
    {
        name: '作家',
        url: './pages/zuojia/list.html'
    },
    {
        name: '作品',
        url: './pages/zuopin/list.html'
    },

]

// 已废弃,不用了
var adminurl =  "http://localhost:8080/zhimingzuojiaguanlixit/admin/dist/index.html#/login";
