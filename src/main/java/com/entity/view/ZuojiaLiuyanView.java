...
public class ZuojiaLiuyanView extends ZuojiaLiuyanEntity implements Serializable {
	...
	public ZuojiaLiuyanView() {

	}

	public ZuojiaLiuyanView(ZuojiaLiuyanEntity zuojiaLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, zuojiaLiuyanEntity);
